...
module ex_100g_altera_xcvr_fpll_s10_htile_191_jh5viiy
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_jh5viiy 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_jh5viiy phase_en_pulse(
        ...
        dps_reset_gen_jh5viiy dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
