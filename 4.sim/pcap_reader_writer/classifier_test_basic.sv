...
//Test samo za provjeru ispravnosti osnovnog rada klasifikatora - jedan unos u tabeli, jednostavan pcap sample, da li ce izdvojiti header kako treba, i naci 
//podudaranje u tabeli, te izdvojiti njegov flow id i routing tag u channel signal


module classifier_test_basic;
