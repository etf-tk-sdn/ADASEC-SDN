...
module  alt_e100s10_fecpll_nxbtffy #(
...
//-------------------------------------------
wire rx_fec_pll_locked;
reg rx_fec_pll_locked_sync, rx_fec_pll_locked_s, rx_fec_pll_locked_s1, rx_fec_pll_locked_s2;
always @ (posedge clk_rx) begin
	rx_fec_pll_locked_sync <= rx_fec_pll_locked;
	rx_fec_pll_locked_s <= rx_fec_pll_locked_sync;
	rx_fec_pll_locked_s1 <= rx_fec_pll_locked_s;
	rx_fec_pll_locked_s2 <= rx_fec_pll_locked_s1;
end
assign rxfec_pll_locked = rx_fec_pll_locked_s | rx_fec_pll_locked_s2;	// filter glitch;
   
wire tx_fec_pll_locked;
reg tx_fec_pll_locked_sync, tx_fec_pll_locked_s, tx_fec_pll_locked_s1, tx_fec_pll_locked_s2;
always @ (posedge clk_tx) begin
	tx_fec_pll_locked_sync <= tx_fec_pll_locked;
	tx_fec_pll_locked_s <= tx_fec_pll_locked_sync;
	tx_fec_pll_locked_s1 <= tx_fec_pll_locked_s;
	tx_fec_pll_locked_s2 <= tx_fec_pll_locked_s1;
end
assign txfec_pll_locked = tx_fec_pll_locked_s | tx_fec_pll_locked_s2;	// filter glitch;
...
wire clk_rx_refclk_sel_adapt = clk_rx;
     ...
     altera_xcvr_fpll_s10_rx fecrxpll 
 	   (           
 		       ...
 		       .pll_locked (rx_fec_pll_locked),		//out -- 	
...
generate
          ...
          assign tx_fec_pll_locked  = (TX_PLL_TYPE == "FPLL") ? txfec_fpll_locked : txfec_iopll_locked;
if (TX_PLL_LOCAT == 0) begin : TXPLL_IN
     if (TX_PLL_TYPE == "FPLL") begin : TXFPLL_INST
        begin        : tx_pll_gen
           ...
           // );
             fectxpll (clk_ref,clk_tx_rs,txfec_fpll_locked);
  ...
  //IOPLL
        ...
        begin        : tx_iopll_gen
            ...
            //   .reconfig_to_pll (reconfig_to_iopll)			//in [29:0] -- from iopll_reconfig
            //   );
             fectxpll (clk_ref_tx,txfec_iopll_locked,tx_pll_reset,clk_tx_rs);
