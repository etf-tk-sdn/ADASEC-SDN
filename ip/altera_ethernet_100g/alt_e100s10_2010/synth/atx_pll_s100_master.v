// atx_pll_s100_master.v

// Generated using ACDS version 26.1.1 130

`timescale 1 ps / 1 ps
module atx_pll_s100_master #(
		...
		parameter atx_pll_lcpll_gt_out_left_enb                                    = "lcpll_gt_out_left_en",
		...
		output wire  gxt_output_to_blw_atx, // gxt_output_to_blw_atx.clk
	...
	generate
		...
		if (atx_pll_lcpll_gt_out_left_enb != "lcpll_gt_out_left_en")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	altera_ethernet_100g_altera_xcvr_atx_pll_s10_htile_1912_cilcl7i #(
		.rcfg_enable                                                      (0),
		.rcfg_jtag_enable                                                 (0),
		...
		.atx_pll_lcpll_gt_out_left_enb                                    ("lcpll_gt_out_left_en"),
		...
		.gxt_output_to_blw_atx   (gxt_output_to_blw_atx),                //  output,  width = 1, gxt_output_to_blw_atx.clk
