...
//--------------------------------------------------
    ...
    // stats_ram blocks
    wire stretched_clear_cnt;
    alt_e100s10_pulse_stretcher #(
        .CYCLES     (36)
    ) ps_clr (
        .clk        (mac_clk),
        .pulse_in   (cnt_clear_sync),
        .pulse_out  (stretched_clear_cnt)
    );
...
//--------------------------------------------------
    ...
    alt_e100s10_stat_ram_16x64b #(
        ...
        .clk                (mac_clk),
        .sclr               (stretched_clear_cnt),
        .sclr_addr          (cnt_clear_sync),
...
`pragma questa_oem_00 ""
`endif