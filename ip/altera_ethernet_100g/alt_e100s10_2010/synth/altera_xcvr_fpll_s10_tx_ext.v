...
module altera_xcvr_fpll_s10_tx_ext #(
		...
		parameter cmu_fpll_refclk_select_mux_silicon_rev                                  = "14nm5bcr2eb",
		...
		parameter cmu_fpll_silicon_rev                                                    = "14nm5bcr2eb",
	...
	generate
		...
		if (cmu_fpll_refclk_select_mux_silicon_rev != "14nm5bcr2eb")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (cmu_fpll_silicon_rev != "14nm5bcr2eb")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	altera_ethernet_100g_altera_xcvr_fpll_s10_htile_1915_6rpkcza #(
		.rcfg_enable                                                             (0),
		.rcfg_jtag_enable                                                        (0),
