...
# ---                                                                    --- #
# -------------------------------------------------------------------------- #
proc fpll_initialize_db_6rpkcza { fpll_db } {
  ...
  fpll_get_pins_6rpkcza $instance_name $all_pins
...
# ---                                                                    --- #
# -------------------------------------------------------------------------- #
proc fpll_get_pins_6rpkcza { instance all_pins } {
  ...
  set fpll_c0_div_reg_list   [fpll_get_fpll_counter_div_reg_node_6rpkcza]
  set fpll_refclk_port_list  [fpll_get_refclk_port_6rpkcza $instance $fpll_c0_div_reg_list]
...
# ---                                                                    --- #
# -------------------------------------------------------------------------- #
proc fpll_get_fpll_counter_div_reg_node_6rpkcza { } {
  global ::fpll_sdc_debug
...
# ---                                                                    --- #
# -------------------------------------------------------------------------- #
proc fpll_get_refclk_port_6rpkcza { instance fpll_c0_div_reg_list } {
  global ::fpll_sdc_debug
...
# ---                                                                          --- #
# -------------------------------------------------------------------------------- #
proc fpll_prepare_to_create_clocks_6rpkcza { instance mode mode_clks profile_cnt profile alt_xcvr_fpll_s10_pins multiply_factor_dict divide_factor_dict all_profile_clocks_names } {
  global ::fpll_sdc_debug
    ...
    if { $mode == "refclk" } {
      ...
      if { [dict exists $alt_xcvr_fpll_s10_pins $instance $clk_group] } {
        ...
        if { [llength $clk_pins] > 0 } { # Check to see if the corresponding pins exists 
          ...
          lappend list_of_clk_names [fpll_create_clocks_6rpkcza $instance $clk_group $clk_pins $profile_cnt $profile $source_node $master_clock $multiply_factor $divide_factor]
        }
      } else {
        if {$fpll_sdc_debug == 1} {
...
# ---                                                                    --- #
# -------------------------------------------------------------------------- #
proc fpll_create_clocks_6rpkcza { instance clk_group clk_list profile_cnt profile source_node master_clock multiply_factor divide_factor } {
  global ::fpll_sdc_debug
