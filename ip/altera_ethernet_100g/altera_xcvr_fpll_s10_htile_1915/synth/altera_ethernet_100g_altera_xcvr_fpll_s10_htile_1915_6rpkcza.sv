...
module altera_ethernet_100g_altera_xcvr_fpll_s10_htile_1915_6rpkcza
#(
  // H-Tile specific
...
alt_xcvr_pll_rcfg_opt_logic_6rpkcza 
#(
...
//
  ...
  // Instantiate pulse-width control module
         dps_pulse_ctrl_6rpkcza phase_en_pulse(
        ...
        dps_reset_gen_6rpkcza dps_reset_gen_1 (
           .clk(reconfig_clk[0]),                  // input clock to the HSSI AVMM
